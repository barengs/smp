<footer class="mt-auto py-4 bg-white dark:bg-bodybg text-center border-t border-defaultborder dark:border-defaultborder/10">
    <div class="container">
        <span class="text-textmuted dark:text-textmuted/50">
            ...
            <a href="javascript:void(0);" class="text-dark font-medium">E-BMP</a>.
            Developed<span class="text-danger">&#10084;</span> by 
            <a href="javascript:void(0);">
                <span class="font-medium text-primary">Barengsaya.Com</span>
            </a> 
            All rights reserved
        </span>
    </div>
