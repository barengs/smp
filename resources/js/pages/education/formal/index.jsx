...
import {useGetFormalEducationsQuery} from "@/store/api/education/formalApiSlice";
...
const FormalEducation = () => {
  const {data, isLoading} = useGetFormalEducationsQuery();
    ...
    <div className='space-y-5'>
      <Card noborder>
        <div className="md:flex justify-between items-center mb-2">
          <h4 className="card-title">Daftar Pendidikan Formal</h4>
          <div className='flex'>
