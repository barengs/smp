...
import {useGetNonFormalEducationsQuery} from "@/store/api/education/nonformalApiSlice";
...
const NonFormalEducation = () => {
  const {data, isLoading} = useGetNonFormalEducationsQuery();
    ...
    <div className='space-y-5'>
      <Card noborder>
        <div className="md:flex justify-between items-center mb-2">
          <h4 className="card-title">Daftar Pendidikan Non-Formal</h4>
          <div className='flex'>
