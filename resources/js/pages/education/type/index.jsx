...
import {useGetEducationTypesQuery} from "@/store/api/education/typeApiSlice";
...
const EducationType = () => {
  const {data, isLoading} = useGetEducationTypesQuery();
    ...
    <div className='space-y-5'>
      <Card noborder>
        <div className="md:flex justify-between items-center mb-2">
          <h4 className="card-title">Daftar Kelompok Pendidikan</h4>
          <div className='flex'>
