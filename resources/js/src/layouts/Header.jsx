            ...
            <div className="main-header-container container-fluid">
                ...
                <ul className="header-content-right">
                    ...
                    <li
                        ...
                        <div className="main-header-dropdown hs-dropdown-menu ti-dropdown-menu hidden" data-popper-placement="none">
                                ...
                                <li className="ti-dropdown-item block">
                                    <div className="flex items-center">
                                        ...
                                        <div className="grow flex items-center justify-between">
                                            ...
                                            <div>
                                                <a href="javascript:void(0);" className="min-w-fit-content dropdown-item-close1">
                            ...
                            <div className="p-4 empty-header-item1 border-t">
                                <div className="grid">
                                    <a href="javascript:void(0);" className="ti-btn ti-btn-primary btn-wave">View All</a>
                                </div>
                            </div>
                    ...
                    <li className="header-element">
                        <a href="javascript:void(0);" className="header-link switcher-icon" data-hs-overlay="#hs-overlay-switcher">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 header-link-icon" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
